...
from arl.orchestrator.models import AgentEventPayload
...
class AgentEventReader:
    def __init__(self, event_log_path: Path) -> None:
        self.event_log_path = event_log_path

    def read_from(self, offset: int) -> EventReadResult:
        ...
        with self.event_log_path.open("r", encoding="utf-8") as handle:
            ...
            while True:
                ...
                try:
                    ...
                    events.append(AgentEventPayload.model_validate(raw))
